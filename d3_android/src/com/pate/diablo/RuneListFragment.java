...
public class RuneListFragment extends ListFragment
{
   Context context;
    ...
    public static RuneListFragment newInstance(String content, Context c, String skillName, UUID skillUUID, String selectedClass, int requiredLevel) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        for (Rune s : D3Application.dataModel.getClassByName(selectedClass).getActiveSkillByUUID(skillUUID).getRunesByRequiredLevel(requiredLevel))
        {
